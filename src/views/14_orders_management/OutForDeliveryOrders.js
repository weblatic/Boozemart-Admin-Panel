...
export default function OutForDeliveryOrders(props) {
    ...
    React.useEffect(() => {
        ...
        const res = sendRequest(apis.base + apis.adminOutForDeliveryOrders, formData, ((res) => callback(res)), ((err) => console.log(err)));
    }, []);
        ...
        <div className="card">
            <div className="card-header card-header-primary">
                <div className="row">
                    <div className="col-md-6">
                        <h1 className="card-title"><b>Out For Delivery Orders</b></h1>
                    </div>
            ...
            <div className="container"><br/>
                <CustomTable
                    ...
                    buttonEx={{}}
                    searchField={true}
                    data={data} api={apis.adminOutForDeliveryOrders} primaryKey={"id"}
