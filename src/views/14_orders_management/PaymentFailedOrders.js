...
export default function PaymentFailedOrders(props) {
    ...
    React.useEffect(() => {
        ...
        const res = sendRequest(apis.base + apis.adminPaymentFailedOrders, formData, ((res) => callback(res)), ((err) => console.log(err)));
    }, []);
        ...
        <div className="card">
            <div className="card-header card-header-primary">
                <div className="row">
                    <div className="col-md-6">
                        <h1 className="card-title"><b>Payment Failed Orders</b></h1>
                    </div>
            ...
            <div className="container"><br/>
                <CustomTable
                    ...
                    buttonEx={{}}
                    searchField={true}
                    data={data} api={apis.adminPaymentFailedOrders} primaryKey={"id"}
