...
export default function Map(props) {
    ...
    React.useEffect(() => {
        ...
        const res = sendRequest(apis.base + apis.mapSetting, formData, ((res) => callback(res)));
    }, []);
    ...
    const submit = () => {
        ...
        let formData = new FormData();
        formData.append("payload", JSON.stringify(body));
        const res = sendRequest(apis.base + apis.mapSetting, formData, ((res) => callbackSubmit(res)));
    };
